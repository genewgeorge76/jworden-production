...
export default function CommercialClientAuthority() {
  const brands = [
    ...
    {
      name: "Capital One Bank — Annandale, VA",
      locations: "Branch #61458, Northern Virginia",
      services: "Full Lot Rehabilitation with Change-Order Scope, Summer 2026",
      badge: "National Banking Client",
      logoText: "Capital One",
      image: "/images/real_jobs/retail-lot-repave-fresh-mat.webp",
