      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pb-24 pt-32 w-full">
        <motion.div
          ...
          <div className="inline-flex items-center gap-4 border-l-2 border-primary bg-zinc-900/80 px-4 py-2 mb-8">
            <span className="font-display text-xs tracking-[0.1em] uppercase text-primary">
              Institutional Grade Infrastructure
            </span>
          </div>
          
          <h1 className="font-display font-bold text-foreground uppercase leading-[0.9] tracking-tight">
          ...
          <div className="mt-16 pt-8 border-t border-zinc-800 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col">
              ...
              <span className="text-xs text-zinc-500 uppercase tracking-[0.08em] mt-1">Operational Excellence</span>
            </div>
            <div className="flex flex-col">
              <span className="text-3xl font-display text-white">5,000+ PROJECTS</span>
              <span className="text-xs text-zinc-500 uppercase tracking-[0.08em] mt-1">Institutional Scale</span>
            </div>
            <div className="flex flex-col">
              <span className="text-3xl font-display text-white">$500M+ ASSETS</span>
              <span className="text-xs text-zinc-500 uppercase tracking-[0.08em] mt-1">Managed Infrastructure</span>
            </div>
          </div>
        </motion.div>
      </div>
