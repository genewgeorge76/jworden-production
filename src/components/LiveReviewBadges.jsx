      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        >
          ...
          <div className="text-left">
            <div className="text-xs font-bold text-gray-800 leading-none">★★★★★</div>
            <div className="text-[10px] text-gray-500 leading-none mt-0.5">Review us on Google</div>
          </div>
        </a>
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      >
        ...
        <div className="text-center">
          ...
          <div className="font-black text-lg text-gray-900">Review us on Google</div>
          <div className="text-sm text-gray-500 mt-1">Share your experience</div>
        </div>
