...
export default function AsphaltMillingAndResurfacingBlog() {
  ...
  return (
    <div className="min-h-screen bg-background font-body">
      ...
      <article className="pt-32 pb-16 md:pb-20 max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="prose prose-invert max-w-none text-muted-foreground leading-relaxed space-y-6">
          ...
          <div className="bg-card border border-border p-8 my-10 rounded-sm">
            ...
            <a href="#quote" className="premium-cta inline-flex items-center gap-2 px-6 py-3 font-display font-bold text-xs tracking-[0.06em] uppercase text-primary-foreground">
      ...
      <QuoteBlock
        source="blog_milling_resurfacing"
        heading="Find Out If Yours Can Be Milled and Resurfaced"
        intro="Milling and resurfacing costs a fraction of a rebuild, but only where the base is still sound. Send the site and we will core it or read it on foot before quoting either one."
      />
