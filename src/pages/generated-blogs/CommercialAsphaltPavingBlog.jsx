...
export default function CommercialAsphaltPavingBlog() {
  ...
  return (
    <div className="min-h-screen bg-background font-body">
      ...
      <QuoteBlock
        source="blog_commercial_paving"
        heading="Get a Commercial Paving Proposal"
        intro="Send the property and the hours it has to stay open. We phase commercial work so the doors never close, and the proposal names the nights we are on site."
      />
