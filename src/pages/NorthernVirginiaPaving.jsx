    ...
    <div className="min-h-screen bg-brand-navy">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-3/5 space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                ...
                <a href="#quote" className="btn-outline py-4 px-8 text-white font-bold">Commercial Quote</a>
              </div>
            ...
            <div className="lg:w-2/5">
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8 space-y-5">
                <h2 className="text-white font-bold text-lg">What Makes NoVA Different.</h2>
      ...
      <section className="py-24 bg-white/5 border-y border-white/10 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-white font-bold text-3xl md:text-5xl tracking-tight">Active Northern Virginia Coverage.</h2>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-white font-bold text-3xl md:text-5xl tracking-tight text-center mb-14">Northern Virginia Paving FAQs.</h2>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto bg-brand-amber rounded-[2.5rem] p-12 md:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-brand-navy/50 font-bold uppercase tracking-[0.08em] text-sm mb-3">Northern Virginia's Virginia Contractor</p>
