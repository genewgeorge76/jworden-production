    ...
    <div className="min-h-screen bg-brand-navy">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                ...
                <a href="#quote" className="btn-outline py-4 px-8 text-white font-bold">Free Local Estimate</a>
              </div>
            ...
            <div className="lg:w-1/2 space-y-4">
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
                <h3 className="text-white/50 text-xs uppercase tracking-[0.08em] font-bold mb-6">Chesterfield Service Zones — Active Coverage</h3>
      ...
      <section className="py-24 bg-white/5 border-y border-white/10 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-white font-bold text-3xl md:text-5xl tracking-tight mb-4">Everything Your Property Needs.</h2>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-white font-bold text-3xl md:text-5xl tracking-tight text-center mb-14">Chesterfield Paving FAQs.</h2>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto bg-brand-amber rounded-[2.5rem] p-12 md:p-16 text-center relative overflow-hidden">
          ...
          <p className="text-brand-navy/50 font-bold uppercase tracking-[0.08em] text-sm mb-3">Chesterfield's Local Contractor</p>
