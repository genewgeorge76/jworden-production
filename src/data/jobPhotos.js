...
export const JOB_PHOTOS = [
  ...
  P('/images/real_jobs/curved-driveway-cobble-edge.jpg', 'Curved driveway with cobblestone edging along a picket fence', 'residential'),
  P('/images/real_jobs/driveway-cobblestone-ribbon.jpg', 'Driveway with a cobblestone center ribbon between two homes', 'residential'),
  ...
  P('/images/real_jobs/2012-10-05 15.28.39.jpg', 'Estate entrance with stone pillars and fresh asphalt', 'residential'),
  P('/images/real_jobs/hero-driveway minestoa.jpg', 'Long driveway freshly paved beside a tree line', 'residential', { market: 'MN' }),
