        ...
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="background:#fff;padding:32px;border:1px solid #eee;">
            <table style="width:100%;font-size:14px;border-collapse:collapse;">
              <tr style="border-bottom:1px solid #f5f5f5;"><td style="padding:10px 16px 10px 0;font-weight:700;color:#333;width:120px;">Name</td><td style="padding:10px 0;color:#555;">${name || '<em>not provided</em>'}</td></tr>
              <tr style="border-bottom:1px solid #f5f5f5;"><td style="padding:10px 16px 10px 0;font-weight:700;color:#333;">Phone</td><td style="padding:10px 0;color:#555;">${phone || '<em>not provided</em>'}</td></tr>
              <tr style="border-bottom:1px solid #f5f5f5;"><td style="padding:10px 16px 10px 0;font-weight:700;color:#333;">Email</td><td style="padding:10px 0;color:#555;">${email || '<em>not provided</em>'}</td></tr>
              <tr style="border-bottom:1px solid #f5f5f5;"><td style="padding:10px 16px 10px 0;font-weight:700;color:#333;">Service</td><td style="padding:10px 0;color:#555;">${service || '<em>not specified</em>'}</td></tr>
              <tr><td style="padding:10px 16px 10px 0;font-weight:700;color:#333;vertical-align:top;">Details</td><td style="padding:10px 0;color:#555;white-space:pre-wrap;">${message || '<em>none</em>'}</td></tr>
            </table>
