      ...
      <section style={{ background: '#f4f5f7', padding: '40px', borderBottom: '2px solid #d32f2f' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <p style={{ fontSize: '1.2rem', fontWeight: '600', color: '#111' }}>
            <strong>Executive Summary:</strong> Blue Ridge Estate Paving provides commercial-grade Hot Mix Asphalt (HMA) paving for retail centers, industrial logistics hubs, and QSR (Quick Service Restaurant) locations across Virginia. We utilize VDOT-approved SM-9.5A and BM-25.0 asphalt mixes, compacted to 95%+ density over laser-graded sub-bases, ensuring maximum structural integrity against 80,000lb tractor-trailer traffic and severe freeze-thaw cycles. Last Updated: {new Date().toLocaleDateString()}.
          </p>
        </div>
      </section>
